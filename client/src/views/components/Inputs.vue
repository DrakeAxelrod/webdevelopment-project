    ...
    <div class="container mb-5">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6">
          <base-input placeholder="Regular"> </base-input>
          <base-input
            placeholder="Search"
        ...
        <div class="col-lg-4 col-sm-6">
          ...
          <base-input placeholder="Success" :valid="false"> </base-input>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="mb-3">
          <small class="text-uppercase font-weight-bold"
            >Form controls (alternative)</small
          >
        </div>
        <div class="row">
          <div class="col-lg-4 col-sm-6">
          ...
          <div class="col-lg-4 col-sm-6">
            <base-input alternative placeholder="Regular" disabled>
            </base-input>
            <base-input
              alternative
              placeholder="Birthday"
          ...
          <div class="col-lg-4 col-sm-6">
            <base-input alternative placeholder="Success" :valid="true">
            </base-input>

            <base-input alternative placeholder="Success" :valid="false">
            </base-input>
          </div>
        </div>
      </div>

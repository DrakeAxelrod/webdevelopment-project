  ...
  <section class="section section-components">
    <div class="container">
      ...
      <base-alert type="success" icon="ni ni-like-2" dismissible>
        <span slot="text"
          ><strong>Success!</strong> This is a success alert—check it out!</span
        >
      </base-alert>

      <base-alert type="info" icon="ni ni-bell-55" dismissible>
        <span slot="text"
          ><strong>Info!</strong> This is an info alert—check it out!</span
        >
      </base-alert>

      <base-alert type="warning" icon="ni ni-bell-55" dismissible>
        <span slot="text"
          ><strong>Warning!</strong> This is a warning alert—check it out!</span
        >
      </base-alert>

      <base-alert type="danger" icon="ni ni-support-16" dismissible>
        <span slot="text"
          ><strong>Danger!</strong> This is an error alert—check it out!</span
        >
      </base-alert>
